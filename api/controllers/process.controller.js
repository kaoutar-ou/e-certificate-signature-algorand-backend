...
const generateCertificate = async (req, res) => {
    ...
    const data_ = {
        test: {
            ...
            mention,
            titre_diplome,
            ministere:ministere? image(path.join(process.cwd(), 'process', 'canvas', 'ministere_2.png')) : null,
            presidence:presidence? image(path.join(process.cwd(), 'process', 'canvas', 'uca.png')): null,
            etablissement:etablissement? image(path.join(process.cwd(), 'process', 'canvas', 'fst.png')) : null,
